...
public class DRFUtils {
	...
	public static final String INPUT_NAME_XPATH = "/syncheck/query[1]/synonymRequest[1]/taxonName/name/nameComplete/text()";
	public static final String SYN_RESPONSE_XPATH = "/syncheck/query/synonymResponse";
	...
	public static final String ACC_NAME_XPATH = "./acceptedName[1]";
	public static final String CLASSIFICATION_XPATH = "./classification";
	public static final String SYN_NAME_XPATH = "./synonym";
	public static final String NAME_XPATH = "./taxonName/name/nameComplete/text()";
	public static final String SRC_NAME_XPATH = "./source/name/text()";
	public static final String SRC_URL_XPATH = "./source/url/text()";
	public static final String SRC_DATASETID_XPATH = "./source/datasetID/text()";
	public static final String SRC_DATASETNAME_XPATH = "./source/datasetName/text()";
	public static final String SCRUTINY_ACCTO_XPATH = "./scrutiny/accordingTo/text()";
	public static final String SCRUTINY_MODIFIED_XPATH = "./scrutiny/modified/text()";
	public static final String INFO_URL_XPATH = "./info/url/text()";
	...
	public static HashSet buildNames(List synreqres_list) {
		...
		while (itrSynreqres.hasNext()) {
			...
			Text iName = (Text)document.selectNode(INPUT_NAME_XPATH);
			sn.name = iName.getText().trim();

			List<Node> responses = document.selectNodes(SYN_RESPONSE_XPATH);
